...
export default function Accoexpence() {
  ...
  useEffect(() => {
    Axios.get("http://localhost:8080/expence")
      .then((expences) => {
  ...
  const handleAddFormSubmit = (event) => {
    ...
    Axios.post("http://localhost:8080/expence", newExpence)
      .then((res) => {
        if (res.status == 200) {
          // success
  ...
  const handleEditFormSubmit = (event) => {
    ...
    Axios.put("http://localhost:8080/expence/id", editedeExpence)
      .then((res) => {
        if (res.status == 200) {
          // success
  ...
  const handleDeleteClick = (expenceId) => {
    Axios.delete(`http://localhost:8080/expence/${expenceId}`)
      .then((res) => {
        if (res.status == 200) {
          // success
          console.log("Puting data", res);
  ...
  useEffect(() => {
    Axios.get("http://localhost:8080/accoexpence")
      .then((accoexpences) => {
  ...
  const handleAccoExpenceAddFormSubmit = (event) => {
    ...
    Axios.post("http://localhost:8080/accoexpence", newAccoExpence)
      .then((res) => {
        if (res.status == 200) {
          // success
  ...
  const handleAccoEditFormSubmit = (event) => {
    ...
    Axios.put(
      "http://localhost:8080/accoexpence/id",
      editedAccoExpence
    )
      .then((res) => {
        if (res.status == 200) {
  ...
  const handleAccoDeleteClick = (accoexpenceId) => {
    Axios.delete(
      `http://localhost:8080/accoexpence/${accoexpenceId}`
    )
      .then((res) => {
        if (res.status == 200) {
          // success
